...
if (session.getAttribute("id") == null) {
	...
	// table의 isResigster 값 변경
	String sql = "UPDATE sugang SET isRegister=0 WHERE student_id =? AND course_id=?";
	...
	out.println("<script>alert('수강신청이 취소되었습니다'); location.href='student_wishlist.jsp';</script>");
